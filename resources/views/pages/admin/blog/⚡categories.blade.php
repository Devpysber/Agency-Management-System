...
new class extends Component
{
    ...
    {
        if (!auth()->user()->hasPermission('Blog', $this->categoryId ? 'Edit' : 'Create')) {
        ...
        session()->flash('success', 'Blog category saved successfully!');
    ...
    public function delete($id)
    {
        if (!auth()->user()->hasPermission('Blog', 'Delete')) {
            session()->flash('error', "You don't have permission to delete blog categories.");
            return;
        }
    ...
    <div class="dashboard">
        ...
        <div class="page-header">
            <div>
                ...
                <p>Manage categories used to group your blog posts.</p>
            </div>
