...
new class extends Component
{
    ...
    public function getSlugPreviewProperty()
    {
        return $this->title ? \Illuminate\Support\Str::slug($this->title) : '';
    }
    ...
    public function form_submit()
    {
        ...
        $post->blog_category_id = $this->blog_category_id ?: null;
...
<div>
    <div class="dashboard">
        ...
        <div class="page-header">
            <div>
                <h1>Add New Post</h1>
                <p>Create a new blog post for your agency.</p>
            </div>
            <div class="header-actions">
                <a href="{{ route('blog.all') }}" class="btn btn-secondary">
                    <i class="fas fa-arrow-left"></i> Back to Posts
                </a>
                <button type="button" form="blogForm" wire:click="form_submit" class="btn btn-primary">
                    <i class="fas fa-save" wire:loading.remove></i> <i class="fas fa-spinner fa-spin" wire:loading></i> Save Post
                </button>
            </div>
        </div>
                        ...
                        <div class="col-lg-8">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror" wire:model.live="title" placeholder="Enter post title">
                                    @if($title)
                                        <small class="text-muted">Slug: <code>{{ $this->slugPreview }}</code></small>
                                    @endif
                                    @error('title')
