...
new class extends Component
{
    ...
    public function mount($id)
    {
        ...
        $this->birth_date = $this->contact->birth_date;
        $this->gender = $this->contact->gender;
        $this->nationality = $this->contact->nationality;
        ...
        $this->assigned_to = $this->contact->assigned_to;
    ...
    {
        // Validate unique email except current record
        $rules = $this->rules;
...
<div>
    <div class="dashboard">
        ...
        <div class="page-header">
            <div>
                <h1>Edit Contact</h1>
                <p>Update contact information in your CRM system.</p>
            </div>
            <div class="header-actions">
                <button type="button" class="btn btn-secondary" wire:click="cancel">
                    <i class="fas fa-arrow-left"></i> Cancel
                </button>
                <button type="submit" form="editContactForm" class="btn btn-primary">
        ...
        <div class="card">
            <div class="card-body">
                <form id="editContactForm" wire:submit="update">
                    <div class="row">
                        <!-- Left Column -->
                        <div class="col-lg-8">
                            <!-- Personal Information -->
