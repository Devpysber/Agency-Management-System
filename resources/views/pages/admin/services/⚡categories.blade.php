...
new class extends Component
{
    ...
    {
        if (!auth()->user()->hasPermission('Services', $this->categoryId ? 'Edit' : 'Create')) {
    ...
    public function delete($id)
    {
        if (!auth()->user()->hasPermission('Services', 'Delete')) {
            session()->flash('error', "You don't have permission to delete service categories.");
            return;
        }
    ...
    <div class="dashboard">
        ...
        <div class="page-header">
            <div>
                ...
                <p>Manage categories used to group your services.</p>
            </div>
