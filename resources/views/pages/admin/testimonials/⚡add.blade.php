    ...
    <div class="dashboard">
        ...
        <div class="page-header">
            <div>
                ...
                <p>Add a new client testimonial or review.</p>
            </div>
            <div class="header-actions">
                <a href="{{ route('testimonials.all') }}" class="btn btn-secondary">
                    <i class="fas fa-arrow-left"></i> Back to Testimonials
                </a>
                <button type="button" form="testimonialForm" wire:click="form_submit" class="btn btn-primary">
                    <i class="fas fa-save" wire:loading.remove></i> <i class="fas fa-spinner fa-spin" wire:loading></i> Save Testimonial
                </button>
            </div>
        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    @enderror
                                    @if ($photo)
                                        <img src="{{ $photo->temporaryUrl() }}" class="img-fluid rounded-circle mt-3" alt="Preview">
                                    @endif
                                </div>
                            </div>
                        </div>
