...
new class extends Component
{
    ...
    public function form_submit()
    {
        if (!auth()->user()->hasPermission('Portfolio', 'Create')) {
            session()->flash('error', "You don't have permission to create portfolio items.");
            return;
        }
        ...
        $item->service_category_id = $this->service_category_id ?: null;
        $item->description = $this->description;
        $item->project_id = $this->project_id ?: null;
        $item->client_name = $this->client_name;
        $item->completed_date = $this->completed_date ?: null;
        $item->status = $this->status ?: 'published';
    ...
    <div class="dashboard">
        ...
        <div class="page-header">
            <div>
                ...
                <p>Showcase a new piece of completed work.</p>
            </div>
            <div class="header-actions">
                <a href="{{ route('portfolio.all') }}" class="btn btn-secondary">
                    <i class="fas fa-arrow-left"></i> Back to Portfolio
                </a>
                <button type="button" form="portfolioForm" wire:click="form_submit" class="btn btn-primary">
                    <i class="fas fa-save" wire:loading.remove></i> <i class="fas fa-spinner fa-spin" wire:loading></i> Save Item
                </button>
            </div>
        </div>
