    ...
    <div class="lg-wrap">
        <div class="lg-brand">
            ...
            <div class="lg-pitch">
                ...
                <p>Choose something you don't use anywhere else — at least 8 characters.</p>
            </div>
        ...
        <div class="lg-panel">
            <div class="lg-card">
                ...
                <p class="sub">Enter your email and a new password to finish resetting.</p>
                ...
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <button type="submit" class="lg-submit">Reset password</button>
                </form>
